		...
		<div class="container" style="color:black">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="color:black">
                    ...
                    {
                        ?>
                            <h4 style="color:black">Your application is successfully submitted.<br>You will be notified about your application status.</h4>
                        <?php
                    }
                        }
                        ?>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
					<table cellpadding="2px" >
						...
						<tr>
							<th><kbd class="white" >Post you have applied:</kbd></th>
							<td><kbd class="white" ><?php if(isset($postss)){ echo strtoupper($postss); } else{ echo "Nill";} ?></kbd></td>
						</tr>
					</table>
				</div>
			</div>
