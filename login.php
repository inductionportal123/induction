...
<head>
    ...
    <!-- Upgrade to Bootstrap 4.5 for stability -->
...
<div class="container">
    <div class="main_container">
        <?php
        if (isset($_GET['changepas']) && $_GET['changepas'] == 'ok') {
        ?>
        ...
        <div class="logo-container text-center">
            <a href="index.php"><img src="images/logo.png" class="img-fluid" alt="FGEI Logo"></a>
        </div>
        ...
        <div class="footer">
            ...
            <p>© 2024 FGEI (C/G). All rights reserved.</p>
        </div>
    </div>
</div>

<script src="script/jquery.inputmask.bundle.js"></script>
<!-- Use Bootstrap 4.5 JS -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js"></script>
<script>
    // Apply input mask only to CNIC field
    $("#login_cnic").inputmask();
    $(document).ready(function(){
        $("#login_submit").click(function(){
            ...
            if (cnic === "" || password === "") {
                $('#response').fadeIn();
                $('#response').addClass('error-msg').html("All fields are required");
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 1) {
                            ...
                            $('#response').fadeIn();
                            $('#response').removeClass('process-msg').addClass('error-msg').html("Login failed. Check your CNIC or password.");
                        }
                    },
                    error: function() {
                        $('#response').fadeIn();
                        $('#response').removeClass('process-msg').addClass('error-msg').html("An error occurred. Please try again.");
                    }
                });
            }
        });
