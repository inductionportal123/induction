...
$newquery = "SELECT per_info.basic_full_name, per_info.basic_father_name, post_apply.post_apply
...
$pdf->SetTextColor(0,0,0);
$pdf->SetXY(56, 82.5);
$pdf->Write(0, "Induction Fund");                
                
$pdf->SetFont('Helvetica');
$pdf->SetFontSize('10');
$pdf->SetTextColor(0,0,0);
$pdf->SetXY(47, 77);
$pdf->Write(0, $bank_account);                
