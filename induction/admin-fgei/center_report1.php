...
<div  class="col-sm-9 col-sm- -3 col-lg-7 col-lg-offset-4 main" >
    ...
    <?php
      if ($_SERVER['REQUEST_METHOD'] == 'GET'  && isset($_GET['submit1']) )
      {
          ...
          $sqlroll = "SELECT `d_rollno` FROM `details` WHERE `d_centerid` = '$cid'";
          ...
          if($sqlrows > 0)
          {
            ...
            <form class="form" method="post" action="exportroll.php">
                <input type="hidden" value="<?php echo $cid; ?>" name="pid">
                <input type="hidden" value="<?php echo $center['center']; ?>" name="center">
                <input type="submit" class="btn btn-success" value="Export To Excel" name="exceldata">
            </form>
            <?php
