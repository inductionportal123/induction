			...
			<div id="ui">
				...
				<div class="row">
						<div class="col-lg-12" align="center">
							<h3 style="color: green;">Edit Users:</h3>
						</div>
				</div>
				...
				<form class="form-group" action=" " method="post">
					...
					<div class="row">
						...
						<div class="col-lg-9" align="left">
							<input type="text" name="name2" class="form-control" <?php if(isset($name2)){ ?> value="<?php  echo $name2 ?>" <?php } ?> required/>
						</div>
					</div>
                    <br>
                    <div class="row">
						...
						<div class="col-lg-9" align="left">
							<input type="password" name="pass2" class="form-control" <?php if(isset($pass2)){ ?> value="<?php  echo $pass2 ?>" <?php } ?>  required />
						</div>
					</div>
				...
				<div class="col-lg-6" align="left">
                            <select name="role2" class="form-control">
                             	<option value="Admin" <?php if(isset($role2) && $role2 == "Admin"){  ?> selected  <?php } ?>>Admin</option>
								<option value="Editor" <?php if(isset($role2) && $role2 == "Editor"){  ?> selected  <?php } ?>>Editor</option>
								<option value="Read Only" <?php if(isset($role2) && $role2 == "Read Only"){  ?> selected  <?php } ?>>Read Only</option>
...
$ip1 = get_client_ip();
        	...
        	$query = "UPDATE `admin` SET `name`='$name1',`pass`='$pass1',`role`='$role1',`timepc` ='$time' ,`ip`='$ip1'  WHERE `id` = '$id'";
        	;
