...
<?php
   ...
   <div id="sidebar-collapse" class="col-sm-3 col-lg-3 sidebar">
    ...
    <?php
    $mid = $_GET['mid'];
    $show = "SELECT * FROM `message` WHERE id='$mid'";
    $exeshow = mysqli_query($conn, $show);
    $msgdata = mysqli_fetch_array($exeshow);  
    ?>
            ...
            <form class="form" method="post" action="">
                <div class="row" style="margin-top:20px" >
                    ...
                    <div class="col-lg-9" align="left" >
                        <textarea class="ckeditor" name="message" required><?php echo $msgdata['message']; ?></textarea>
				    </div>
				</div>
                <div class="row" style="margin-top:20px" >
                    <div class="col-lg-1" align="left">
    ...
    <?php
      if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['Update']))
      {
          $msg = $_POST['message'];
          $status = $_POST['status'];
          $msgquery = "UPDATE `message` SET `message`='$msg',`status`='$status' WHERE id='$mid'";
