...
<div  class="col-sm-9 col-sm- -3 col-lg-7 col-lg-offset-4 main" >
    <div class="row">
        <div class="col-lg-12" align="center">
            <h3 style="color: green;">Interview File</h3>
        </div>
    </div>
        <div class="row">
        <div class="col-lg-12" align="center">
    ...
    <div class="col-lg-12 mt-4">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['submit1'])) {
            ...
            $sqlroll = "SELECT per_info.contact_cnic, per_info.basic_full_name, per_info.basic_father_name, per_info.basic_dob, per_info.highest_qualification 
            FROM per_info INNER JOIN post_apply ON post_apply.said=per_info.said WHERE post_apply.post_apply = '$cid'";
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="thead-dark">
                            ...
                            <tr>
                                ...
                                <th>Relevant Qual / Experience (15)</th>
                                <th>Knowledge / Skill Relevancy (20)</th>
                                <th>Personality / Interpersonal Comm Skills (15)</th>
                                <th>Total Interview Marks</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
