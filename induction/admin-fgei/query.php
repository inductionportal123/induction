...
<div class="col-sm-9 col-sm-offset-3 col-lg-8 col-lg-offset-4 main">
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <a href="queryall.php"><button class="btn btn-primary btn-md text-bold" style="width:60%">Answered</button></a>
            </div>
            <div class="col-lg-3">
                <a href="querypending.php"><button class="btn btn-primary btn-md text-bold" style="width:60%">Pending</button></a>
            </div>
        </div>
    </div>
