    ...
    while( $postsmain = mysqli_fetch_assoc($postsresult))
    {
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'  && isset($_POST['selectregion']))
        {
            ...
            <tbody>
                ...
                $tcq = "SELECT COUNT(*),post_apply.said,post_apply.city_prefer,post_apply.post_apply,details.d_said,details.d_postid,per_info.said,qualification.said,emp_document.said FROM `post_apply` 
...
WHERE FIND_IN_SET('$pid',post_apply.post_apply) AND post_apply.city_prefer IN ($cityarray) AND details.d_postid='$pid' AND per_info.undertaking = 1";
                $tcq2 = mysqli_query($conn, $tcq);
                $tcresult = mysqli_fetch_array($tcq2);
            $totalapplied = $totalapplied + $tcresult[0];
                ...
                //approvedcount
                $acq = "SELECT COUNT(*),post_apply.city_prefer,post_apply.said,post_apply.post_apply,details.d_said,details.d_postid,per_info.said,qualification.said,emp_document.said FROM `post_apply` 
...
WHERE FIND_IN_SET('$pid',post_apply.post_apply) AND post_apply.city_prefer IN ($cityarray)  AND details.d_postid='$pid' AND details.d_status = 'Approved' AND per_info.undertaking = 1";
                $acq2 = mysqli_query($conn, $acq);
                $acresult = mysqli_fetch_array($acq2);
                        $totalapproved =$totalapproved +  $acresult[0];
                //rejectedcount
                $rcq = "SELECT COUNT(*),post_apply.city_prefer,post_apply.said,post_apply.post_apply,details.d_said,details.d_postid,per_info.said,qualification.said,emp_document.said FROM `post_apply` 
...
WHERE FIND_IN_SET('$pid',post_apply.post_apply) AND post_apply.city_prefer IN ($cityarray)  AND details.d_postid='$pid' AND details.d_status = 'Rejected' AND per_info.undertaking = 1";
                $rcq2 = mysqli_query($conn, $rcq);
              $rcq3 = mysqli_num_rows($rcq2);

                $rcresult = mysqli_fetch_array($rcq2);
                        $totalrejected =$totalrejected +  $rcresult[0];
                //pendingcount
...
WHERE FIND_IN_SET('$pid',post_apply.post_apply) AND post_apply.city_prefer IN ($procityarray) AND details.d_postid='$pid' AND per_info.undertaking = 1";
                $tcq2 = mysqli_query($conn, $tcq);
                $tcresult = mysqli_fetch_array($tcq2);
            $totalapplied = $totalapplied + $tcresult[0];
                //approvedcount
...
WHERE FIND_IN_SET('$pid',post_apply.post_apply) AND post_apply.city_prefer IN ($procityarray)  AND details.d_postid='$pid' AND details.d_status = 'Approved' AND per_info.undertaking = 1";
                $acq2 = mysqli_query($conn, $acq);
                $acresult = mysqli_fetch_array($acq2);
            $totalapproved =$totalapproved +  $acresult[0];
                //rejectedcount
...
WHERE FIND_IN_SET('$pid',post_apply.post_apply) AND post_apply.city_prefer IN ($procityarray)  AND details.d_postid='$pid' AND details.d_status = 'Rejected' AND per_info.undertaking = 1";
                $rcq2 = mysqli_query($conn, $rcq);
              $rcq3 = mysqli_num_rows($rcq2);
...
WHERE FIND_IN_SET('$pid',post_apply.post_apply) AND post_apply.city_prefer = $distcity AND details.d_postid='$pid' AND per_info.undertaking = 1";
                $tcq2 = mysqli_query($conn, $tcq);
                $tcresult = mysqli_fetch_array($tcq2);
          $totalapplied = $totalapplied + $tcresult[0];
                //approvedcount
...
WHERE FIND_IN_SET('$pid',post_apply.post_apply) AND post_apply.city_prefer = $distcity  AND details.d_postid='$pid' AND details.d_status = 'Approved' AND per_info.undertaking = 1";
                $acq2 = mysqli_query($conn, $acq);
                $acresult = mysqli_fetch_array($acq2);
          $totalapproved =$totalapproved +  $acresult[0];
                //rejectedcount
...
WHERE FIND_IN_SET('$pid',post_apply.post_apply) AND post_apply.city_prefer = $distcity  AND details.d_postid='$pid' AND details.d_status = 'Rejected' AND per_info.undertaking = 1";
                $rcq2 = mysqli_query($conn, $rcq);
              $rcq3 = mysqli_num_rows($rcq2);
...
else
      {
            ...
            <tbody>
                ...
                $pid = $postsmain['pid'];
                //totalcount
                $tcq = "SELECT COUNT(*),post_apply.said,post_apply.post_apply,details.d_said,details.d_postid,per_info.said,qualification.said,emp_document.said FROM `post_apply` 
...
WHERE FIND_IN_SET('$pid',post_apply.post_apply) AND details.d_postid='$pid' AND per_info.undertaking = 1";
                ...
                $totalapplied = $totalapplied + $tcresult[0];
                //approvedcount
                $acq = "SELECT COUNT(*),post_apply.said,post_apply.post_apply,details.d_said,details.d_postid,per_info.said,qualification.said,emp_document.said FROM `post_apply` 
...
WHERE FIND_IN_SET('$pid',post_apply.post_apply) AND details.d_postid='$pid' AND details.d_status = 'Approved' AND per_info.undertaking = 1";
                $acq2 = mysqli_query($conn, $acq);
                $acresult = mysqli_fetch_array($acq2);
    $totalapproved =$totalapproved +  $acresult[0];
                //rejectedcount
                $rcq = "SELECT COUNT(*),post_apply.said,post_apply.post_apply,details.d_said,details.d_postid,per_info.said,qualification.said,emp_document.said FROM `post_apply` 
