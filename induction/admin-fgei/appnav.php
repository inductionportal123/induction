...
{?>
    <div id="sidebar-collapse" class="col-sm-3 col-lg-3 sidebar">
		...
		<ul class="nav menu">
            <li class="parent ">
                <a class="active"  data-toggle="collapse" href="#sub-item-4">
				...
				<ul class="children" id="sub-item-4">
					<li><a class="" href="allapplication.php">
						<span class="fa fa-arrow-right">&nbsp;</span> Held Applications
					</a></li>
                    ...
                    <li><a class="" href="searchroll.php">
						<span class="fa fa-arrow-right">&nbsp;</span> Search by CNIC
					</a></li>
            ...
            <li class="parent ">
				...
				<ul class="children" id="sub-item-5">
					...
					<li><a href="center_report.php"><em class="fa fa-list-ol">&nbsp;</em> Quota Wise Merit List</a></li>
					<li><a href="interview_file.php"><em class="fa fa-university">&nbsp;</em> Interview File</a></li>
		...
		<ul class="nav menu">
            <li class="parent ">
				...
				<ul class="children" id="sub-item-4">
					...
					<li><a class="" href="search_user.php">
						<span class="fa fa-arrow-right">&nbsp;</span> Search User Status
					</a></li>
				</ul>
			</li>
            <li class="parent ">
		...
		<ul class="nav menu">
            ...
            <li class="parent ">
				...
				<ul class="children" id="sub-item-4">
					...
					<li><a class="" href="centerchange.php">
						<span class="fa fa-arrow-right">&nbsp;</span> Change City
					</a></li>
					<li><a class="" href="search_user.php">
						<span class="fa fa-arrow-right">&nbsp;</span> Search User Status
					</a></li>
					<li><a class="" href="slip_report.php">
						<span class="fa fa-arrow-right">&nbsp;</span> Slip Report
					</a></li>
										                    <li><a href="stats.php"><em class="fa fa-list-ol">&nbsp;</em> Register Applicants</a></li>
