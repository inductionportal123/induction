			...
			<div id="ui">
				...
				<div class="row">
						<div class="col-lg-12" align="center">
							<h3 style="color: green;">Bank Fees:</h3>
						</div>
				</div>
...
<!--
				<form class="form-group" action=" " method="post">
                    ...
                    <?php 
                          $query21 = "SELECT * FROM `bank_fee` ORDER BY id ASC ";
                          $exe21 = mysqli_query($conn,$query21);
			              $rowcount21 = mysqli_num_rows($exe21);
                          if($rowcount21 == 2)
                          {  
                            ?>
                            <input type="submit" name="submit" value="Save" class="btn btn-lg btn-block btn-primary" disabled>
                            <?php
                          }
                            elseif($rowcount21 < 2){?>
...
-->
        ...
        {
        	$bank_name =strtolower($_POST['bank']);
        	$bank_fee = $_POST['fee'];

        	$query = "INSERT INTO `bank_fee`(`name`, `fee`) VALUES ('$bank_name','$bank_fee')";
        	...
        	$exe = mysqli_query($conn,$query);
				...
				{
						header('Location:bankfee.php?insert=success');
...
?>
       ...
       <table class="table table-bordered" width="100%">
                          <tr>
                            ...
                            <th style="text-align: center;">Bank Fee</th>
...
?>
                          ...
                          <tr>
							...
							<td style="text-align: center;"><?php echo strtoupper($rows['name']); ?></td>
							<td style="text-align: center;"><?= $rows['fee'] ?></td>
                            <td style="text-align: center;"><a href="editbank.php?id=<?=$rows['id']?>" >Edit</td>
                           </tr>
