...
$pid = $_POST['pix'];
$checkHead=0;
    $sql="SELECT * FROM `per_info`,`emp_document`,`post_apply`,`details` WHERE emp_document.said=per_info.said AND post_apply.said=emp_document.said AND post_apply.said=details.d_said ";
  $result=mysqli_query($conn,$sql);
  $checkId=0;
     $output = '';
    
    $output .='<h4>List of all candidates</h4><br>';
  $output .='
