...
<div class="container">
	<div class="text-center mb-4">
		<a href="index.php"><img src="images/logo.png" style="max-width: 180px;"></a>
	</div>
	...
	$(document).ready(function(){
		$("#signup_submit").click(function(){
			...
			if(cnic == "" || c_cnic == "" || fname == "" || email == "" || password == "" || confirm_password == "") {
				...
				$('#response').fadeIn().html("Check CNIC format").addClass('error-msg');
			}
			else if(cnic != c_cnic) {
				...
				$.ajax({
					...
					success: function(data) {
						if(data == 1) {
							...
							$('#response').fadeIn().html("CNIC already exists").addClass('error-msg');
						}
					}
				});
			}
