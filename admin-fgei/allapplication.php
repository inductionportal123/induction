...
<div  class="col-sm-9 col-sm-offset-3 col-lg-7 col-lg-offset-4 main" >
    <div class="row">
        <div class="col-lg-12" align="center">
            <h3 style="color: green;">Held Applications</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12" align="center">
...
WHERE FIND_IN_SET('$pid',post_apply.post_apply) AND details.d_postid='$pid' AND details.d_status = 'Doubted' AND per_info.undertaking = 1 LIMIT 15";
