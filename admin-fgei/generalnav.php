<div id="sidebar-collapse" class="col-sm-3 col-lg-3 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="parent ">
                <a  data-toggle="collapse" href="#sub-item-01">
				<em class="fa fa-navicon">&nbsp;</em> Categories <span data-toggle="collapse" href="#sub-item-01" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
				<ul class="children collapse" id="sub-item-01">
                    <li class="active"><a href="Qualification_Cate.php"><em class="fa fa-book">&nbsp;</em> Qualification Category</a></li>
					<li><a href="Specialization.php"><em class="fa fa-globe">&nbsp;</em> Specialization</a></li>
            ...
            <li class="parent ">
				...
				<ul class="children collapse" id="sub-item-5">
					...
					<li><a href="QuotaWiseMeritList.php"><em class="fa fa-list-ol">&nbsp;</em> Quota Wise Merit List</a></li>
					<li><a href="interview_file.php"><em class="fa fa-university">&nbsp;</em> Interview File</a></li>
					<li><a href="final_merit_list.php"><em class="fa fa-university">&nbsp;</em> Final Merit List</a></li>
